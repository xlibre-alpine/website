...
To keep Git history small on this branch, legacy prebuilt versions of the X11Libre server will eventually be purged time to time based on the following (whichever comes first):
